...
import { getMountedApps, navigateToUrl, registerApplication, start as start$1 } from 'single-spa';
...
function _validateSingularMode() {
  ...
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee11(validate, app) {
...
export { registerMicroApps, runAfterFirstMounted, runDefaultMountEffects, setDefaultMountApp, start };
